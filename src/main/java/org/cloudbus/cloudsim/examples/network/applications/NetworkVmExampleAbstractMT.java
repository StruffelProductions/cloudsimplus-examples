 ...
 */
abstract class NetworkVmExampleAbstractMT {
     ...
     */
    private final Map<Integer, List<NetworkCloudletMT>> appMap;

    /**
     * Creates, starts, stops the simulation and shows results.
     */
    NetworkVmExampleAbstractMT() {
     ...
     */
    protected static void addExecutionTask(NetworkCloudletMT cloudlet) {
     ...
     */
    protected final List<NetworkCloudletMT> createAppAndSubmitToBroker(DatacenterBroker broker) {
        final List<NetworkCloudletMT> list = createNetworkCloudlets(broker);
     ...
     */
    protected abstract List<NetworkCloudletMT> createNetworkCloudlets(DatacenterBroker broker);
    ...
    protected void addSendTask(
        NetworkCloudletMT sourceCloudlet,
        NetworkCloudletMT destinationCloudlet)
    {
