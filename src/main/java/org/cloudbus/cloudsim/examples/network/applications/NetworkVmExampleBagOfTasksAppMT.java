 ...
 */
public class NetworkVmExampleBagOfTasksAppMT extends NetworkVmExampleAbstractMT {
    ...
    public static void main(String[] args) {
        new NetworkVmExampleBagOfTasksAppMT();
    }

    private NetworkVmExampleBagOfTasksAppMT(){
        super();
    }

    @Override
    public List<NetworkCloudletMT> createNetworkCloudlets(DatacenterBroker broker){
        final int CLOUDLETS_BY_APP = 2;
        final List<NetworkCloudletMT> cloudletList = new ArrayList<>(CLOUDLETS_BY_APP+1);
        ...
        for(int i = 0; i < CLOUDLETS_BY_APP; i++){
            ...
            final var cloudlet = new NetworkCloudletMT(i, CLOUDLET_LENGTH, CLOUDLET_PES);
    ...
    private void createTasksForNetworkCloudlets(final List<NetworkCloudletMT> networkCloudletList) {
        for (NetworkCloudletMT cloudlet : networkCloudletList) {
